...
class ReqToTokenPool:
    ...
    def set_from_model_hub(self, is_from_model_hub: bool):
        self.is_from_model_hub = is_from_model_hub
...
class MHATokenToKVPool(KVCache):
    ...
    def _create_buffers(self):
        logger.info(f"create buffers, size: {self.size}, page_size: {self.page_size}, head_num: {self.head_num}, head_dim: {self.head_dim}, layer_num: {self.layer_num}, store_dtype: {self.store_dtype}")
