...
# from sglang_lib.scheduler import run_scheduler_process
...
class Engine(EngineBase):
    ...
    def __init__(self, 
                 server_configs_list: Optional[List[ServerArgs]] = None,
                 router_args: Optional[Dict] = None, **kwargs):
        """
        ...
        if server_configs_list is not None:
            ...
            for server_args_config in server_configs_list:
                if isinstance(server_args_config, dict):
                    ...
                    server_args = ServerArgs(**server_args_config)
            ...
            server_args = server_args_list[-1]
        elif "server_args" in kwargs:
            # Directly load server_args
            server_args = kwargs["server_args"]
        else:
            # Construct server_args from kwargs
...
def _launch_subprocesses(
    ...
    tokenizer_manager = TokenizerManager(server_args, port_args, router_args)
