...
class EAGLEWorker(TpModelWorker):
    ...
    def __init__(
        ...
        # server_args.context_length = target_worker.worker.model_config.context_len
    ...
    def forward_draft_extend(
        ...
        """
        # logger.info(f"going from EAGLEWorker.forward_draft_extend")
        # logger.info(f"hidden_states: {hidden_states}, next_token_ids: {next_token_ids}")
