...
class ServerArgs:
    ...
    def __post_init__(self):
        ...
        #     ) = ModelHub.init_spec_server_args(self)

        # if self.speculative_algorithm in ("EAGLE", "EAGLE3", "NORMAL"):
        if self.enable_spec():
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            ...
            type=str,
            choices=["EAGLE", "EAGLE3", "NEXTN", "NORMAL"],
    ...
    def enable_spec(self):
        return self.speculative_algorithm in ("EAGLE", "EAGLE3", "NORMAL")
